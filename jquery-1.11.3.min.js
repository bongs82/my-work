 ...
 * touchScroll
 */
$(function(o){var n={useCss:!0,useTouch:!0,useScrollbar:!1,useWheel:!1,scrollbarClass:"default",displayBar:"show",wheelMove:80,responsive:!0,scrollInit:function(){}};return o.fn.touchScroll=function(i){function t(){var n=[],i=u("y");return v.option.target.children().each(function(t){var e=o(this).position(),r=e.top-i;n[t]=-r}),n}function e(){var o=parseInt(h.innerHeight(),10),n=parseInt(v.option.target.innerHeight(),10);return n>o?o-n:0}function r(){var o=parseInt(h.innerHeight(),10),n=parseInt(v.option.target.innerHeight(),10);return p(v.anim.maxScroll,n,o)}function a(){var o=parseInt(h.innerHeight(),10),n=parseInt(v.option.target.innerHeight(),10),i=n>o?o/n*o:0;return 0===i&&v.option.scrollbarWrap.css("height",0),parseInt(i,10)}function s(o){var n=parseInt(h.innerHeight(),10),i=parseInt(v.option.target.innerHeight(),10);return v.position.scrollEnd.y=p(o,i,n),v.position.scrollEnd.y}function l(o){var n=parseInt(h.innerHeight(),10),i=parseInt(v.option.target.innerHeight(),10);return p(o,n,i)}function p(o,n,i){var t=o/n*i;return-1*Math.round(t)}function c(o,n,i){if(v.option.useScrollbar){var n=n||0,i=i||!1;v.option.useCss?(v.option.scrollbarElem.css(v.anim.transDuration,n+"ms"),v.option.scrollbarElem.css(v.anim.transForm,"translate(0px, "+o+"px)")):i?v.option.scrollbarElem.animate({"margin-top":o+"px"}):v.option.scrollbarElem.css("margin-top",o+"px")}}function m(o,n,i){var n=n||0,i=i||!1;v.option.useCss?(v.option.target.css(v.anim.transDuration,n+"ms"),v.option.target.css(v.anim.transForm,"translate(0px, "+o+"px)")):i?v.option.target.animate({"margin-top":o+"px"}):v.option.target.css("margin-top",o+"px")}function u(o){if(v.option.useCss)var n=v.option.target.css("transform"),i=n.replace(/[^0-9\-.,]/g,"").split(","),t=i[12]||i[4],e=i[13]||i[5];else var e=v.option.target.css("margin-top");var o="y"===o?e:t;return parseInt(o,10)}function d(o,n){var i,t,e=o,r=Math.abs(e)/n;return t=e*r,i=r/.005,{movingY:t,duration:i}}function g(o,n,i){window.addEventListener?n.addEventListener(o,i,!0):window.attachEvent?n.attachEvent("on"+o,i):n[o]=i}var v={},h=this,b=function(){v.option=o.extend({},n,i),v.anim={},v.option.useCss=v.option.useCss&&function(){var o=document.createElement("div"),n=["WebkitPerspective","MozPerspective","OPerspective","msPerspective"],i=n.length,t=0;for(t;i>t;t+=1)if(void 0!==o.style[n[t]])return v.anim.prefix=n[t].replace("Perspective","").toLowerCase(),v.anim.transForm="-"+v.anim.prefix+"-transform",v.anim.transDuration="-"+v.anim.prefix+"-transition-duration",!0;return!1}(),v.mobileCheck=function(){var o=!1;return function(n,i){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(n)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(n.substr(0,4)))&&(o=!0)}(navigator.userAgent||navigator.vendor||window.opera),o}(),v.anim.touchEvent=v.mobileCheck?["touchstart","touchmove","touchend"]:["mousedown","mousemove","mouseup"],v.option.target=h.children().first(),v.scrollCheck={},v.option.timer=null,f(),v.option.useScrollbar&&y(),v.option.useWheel&&I(),v.option.useTouch&&w(),v.option.useScrollbar&&S(),v.option.responsive&&M(),v.option.scrollInit()},f=function(){"fixed"!==h.css("position")&&"absolute"!==h.css("position")&&h.css("position","relative"),h.css("overflow","hidden"),v.position={start:{y:0},move:{y:0},end:{y:0},moving:{oldY:0,newY:0},scrollEnd:{y:0},momentum:{y:0}},m(0),h.getMaxScroll(),v.position.elemArr=t(),v.option.useTouch&&(h.bind("mousedown",function(){return!1}),g("click",h[0],function(o){v.anim.scrolling&&(o.preventDefault?o.preventDefault():o.returnValue=!1,o.stopPropagation?o.stopPropagation():o.cancelBubble=!0,o.preventDefault&&o.preventDefault(),o.stopPropagation&&o.stopPropagation())}))},y=function(){if(!h.find(".touch-scrollbar-y-wrap").length>0){var n=o('<div class="touch-scrollbar-y-wrap" />'),i=o('<div class="touch-scrollbar" />');n.append(i),h.append(n)}v.option.scrollbarWrap=h.find(".touch-scrollbar-y-wrap"),v.option.scrollbarElem=h.find(".touch-scrollbar"),v.option.scrollbarWrap.addClass(v.option.scrollbarClass),h.getScrollbarHeight(),c(0),v.anim.maxScrollbar=r(),"fade"===v.option.displayBar&&(v.option.scrollbarWrap.css("display","none"),h.on({mouseenter:function(){v.option.scrollbarWrap.stop(!0,!1).fadeIn()},mouseleave:function(){v.option.scrollbarWrap.stop(!0,!1).fadeOut()},touchstart:function(){v.option.scrollbarWrap.stop(!0,!1).fadeIn()},touchend:function(){v.option.scrollbarWrap.stop(!0,!1).fadeOut()}})),v.option.scrollbarWrap.css({position:"absolute",top:0,right:0,height:"100%",width:"3px",overflow:"hidden"}),v.option.scrollbarElem.css({position:"absolute",backgroundColor:"gray",top:0,right:"0",width:"3px"})},w=function(){v.option.target.bind(v.anim.touchEvent[0],x)},x=function(o){if(v.startTime=(new Date).getTime(),0!==v.anim.maxScroll){var n=o.originalEvent;v.position.start.y=v.mobileCheck?n.touches[0].pageY:n.clientY,v.option.useCss||(v.option.target.stop(!0,!1),v.option.useScrollbar&&v.option.scrollbarElem.stop(!0,!1)),v.option.target.bind(v.anim.touchEvent[1],k),v.option.target.bind(v.anim.touchEvent[2],E),v.anim.scrolling=!1,v.position.moving.oldY=v.position.start.y,v.position.end.y=u("y"),m(v.position.end.y),c(s(v.position.end.y))}},k=function(o){o.preventDefault();var n,i,t=o.originalEvent;if(i=v.mobileCheck?t.touches[0].pageY:t.clientY,v.position.move.y=i-v.position.start.y,(v.position.move.y>10||v.position.move.y<-10)&&(v.anim.scrolling=!0),n=v.position.end.y+v.position.move.y,n<v.anim.maxScroll?n=v.anim.maxScroll+(n-v.anim.maxScroll)/4:n>0&&(n/=4),m(n),c(s(n)),v.option.useCss){v.position.moving.newY=i-v.position.moving.oldY;var e=(new Date).getTime();e-v.startTime>150&&(v.startTime=e,v.position.moving.oldY=i)}},E=function T(o){v.scrollCheck.start=!1,v.scrollCheck.end=!1,v.position.end.y=v.position.end.y+v.position.move.y;var n=600;if(v.option.useCss){v.endTime=(new Date).getTime();var i=v.endTime-v.startTime;if(v.position.end.y<0&&v.position.end.y>v.anim.maxScroll&&v.anim.scrolling&&150>i&&0!==i){var t=d(v.position.moving.newY,i);v.position.end.y+=t.movingY,n=t.duration}}v.position.end.y<v.anim.maxScroll?(v.scrollCheck.end=!0,v.position.end.y=v.anim.maxScroll):v.position.end.y>0&&(v.scrollCheck.start=!0,v.position.end.y=0),v.scrollCheck.start||v.scrollCheck.end?(m(v.position.end.y,n,!0),c(s(v.position.end.y),n,!0)):(m(v.position.end.y,n,!0),c(s(v.position.end.y),n,!0)),v.option.target.unbind(v.anim.touchEvent[1],k),v.option.target.unbind(v.anim.touchEvent[2],T),v.position.move.y=0},S=function(){v.option.useScrollbar&&v.option.scrollbarElem.bind(v.anim.touchEvent[0],C)},C=function(n){if(n.stopPropagation(),n.preventDefault(),0!==v.anim.maxScroll){var i=n.originalEvent;v.position.start.y=v.mobileCheck?i.touches[0].pageY:i.clientY,o(document).bind(v.anim.touchEvent[1],D),o(document).bind(v.anim.touchEvent[2],Y)}},D=function(o){o.stopPropagation(),o.preventDefault();var n,i=o.originalEvent;v.position.move.y=v.mobileCheck?i.touches[0].pageY-v.position.start.y:i.clientY-v.position.start.y,n=v.position.scrollEnd.y+v.position.move.y,n>v.anim.maxScrollbar?n=v.anim.maxScrollbar:0>n&&(n=0),m(l(n)),c(n)},Y=function H(n){v.position.scrollEnd.y=v.position.scrollEnd.y+v.position.move.y,v.position.scrollEnd.y>v.anim.maxScrollbar?v.position.scrollEnd.y=v.anim.maxScrollbar:v.position.scrollEnd.y<0&&(v.position.scrollEnd.y=0),v.position.end.y=l(v.position.scrollEnd.y),o(document).unbind(v.anim.touchEvent[1],D),o(document).unbind(v.anim.touchEvent[2],H),v.position.move.y=0},I=function(){var o=null;h.bind("mousewheel DOMMouseScroll",function(n){var i=0;o=!1,"mousewheel"==n.type?i=-1*n.originalEvent.wheelDelta:"DOMMouseScroll"==n.type&&(i=40*n.originalEvent.detail),i>0?(v.position.end.y===v.anim.maxScroll&&(o=!0),v.position.end.y-=v.option.wheelMove):0>i&&(0===v.position.end.y&&(o=!0),v.position.end.y+=v.option.wheelMove),o||n.preventDefault(),v.position.end.y<v.anim.maxScroll&&(v.position.end.y=v.anim.maxScroll),v.position.end.y>0&&(v.position.end.y=0),m(v.position.end.y),c(s(v.position.end.y))})},M=function(){o(window).resize(function(){clearTimeout(v.option.timer),v.option.timer=setTimeout(function(){h.refresh()},50)})};return h.refresh=function(){h.getMaxScroll(),h.getPosition(),v.position.end.y<v.anim.maxScroll&&(v.position.end.y=v.anim.maxScroll),m(v.position.end.y,600,!0),v.option.useScrollbar&&(h.getMaxScrollbar(),h.getScrollbarHeight(),c(s(v.position.end.y),600,!0))},h.getMaxScroll=function(){v.anim.maxScroll=e()},h.getMaxScrollbar=function(){v.anim.maxScrollbar=r()},h.getPosition=function(){v.position.elemArr=t()},h.getScrollbarHeight=function(){v.option.scrollbarWrap.css("height",h.innerHeight()),v.option.scrollbarElem.css("height",a())},h.scrollTo=function(o){v.anim.scrolling||(v.position.end.y=v.position.elemArr[o],v.position.end.y<v.anim.maxScroll&&(v.position.end.y=v.anim.maxScroll),m(v.position.end.y,600,!0),v.option.useScrollbar&&c(s(v.position.end.y),600,!0))},b(),h},this}(jQuery));